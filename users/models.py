...
class User(AbstractUser):
    ...
    id_type = models.CharField(
        verbose_name="Tipo de Identificación", max_length=50, choices=ID_TYPE
    )
    identificaction = models.CharField(
        verbose_name="Número de Identificación", max_length=50
    )
    ...
    country = models.BooleanField(
        verbose_name="País de Residencia", max_length=150, null=True, blank=True
    )
    city = models.BooleanField(
        verbose_name="Ciudad de Residencia", max_length=150, null=True, blank=True
    )
    ...
    phone = models.CharField(
        verbose_name="Número de Teléfono", max_length=20, null=True, blank=True
    )
    relocate = models.BooleanField("Disponibilidad para reubicarse", default=False)
...
class Links(models.Model):
    ...
    type_link = models.CharField(
        verbose_name="Tipo de Link", max_length=50, choices=LINK_TYPE
    )
...
class ResumeUser(models.Model):
    ...
    type_resume = models.CharField(
        verbose_name="Tipo de Resumen", max_length=50, choices=RESUME_SECTION
    )
    ...
    def __str__(self):
        for resume in self.RESUME_SECTION:
            if resume[0] == self.type_resume:
                return resume[1]
